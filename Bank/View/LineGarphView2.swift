            ...
            ZStack{
                ...
                Path{path in
                    ...
                    if flag{
                        ...
                        path.addQuadCurve(to: CGPoint(x: 50, y: 90), control: CGPoint(x: 25, y: 70))
                        path.addQuadCurve(to: CGPoint(x: 100, y: 90), control: CGPoint(x: 50, y: 50))
                    path.addQuadCurve(to: CGPoint(x: 450, y: 90), control: CGPoint(x: 70, y: 35))
                    }
